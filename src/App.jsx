...
const App = () => {
  ...
  return (
    <div className="m-4 flex gap-4 text-white">
      {/* GENRES */}
      <div className="rounded-xl h-fit bg-[#33374f] hidden sm:block shadow-[#1b1d29] w-[240px] shadow">
        ...
        <div className="w-full rounded-xl bg-[#33374f] shadow-[#1b1d29] shadow py-2">
          ...
          <div className="px-2 text-lg font-bold text-center flex items-center justify-between flex-col w-full ">
            <div className="flex justify-between items-center w-full relative">
              ...
              <div
                className={`h-[250px] md:h-[400px] w-full m-2 shadow ${
                  !firstGame && "shadow-none"
                } shadow-[#1b1d29] rounded-xl`}
              >
                {firstGame ? (
                  <img
